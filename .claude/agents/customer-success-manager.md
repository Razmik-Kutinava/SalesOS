...
description: Автономно мониторит здоровье клиентов, выявляет возможности расширения
  и создаёт стратегические планы успеха для корпоративных аккаунтов
tools: Read, WebSearch, Grep, Bash
model: sonnet
---
...
4. **Expansion Opportunity Analysis**
